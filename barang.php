...
<div class="card-body">
        ...
        <a href="tambah-barang.php"><button type="button" class="btn btn-primary">Tambah Data</button></a>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                                echo "
                                <a href='edit-barang.php?id=$barang[id]'><button type='button' class='btn btn-success btn-sm'>Edit</button></a>
                                |
                                <a href='javascript:deleteData(".$barang['id'].")'><button type='button' class='btn btn-warning btn-sm'>Hapus</button></a>
                                "
                            ?>
                        </td>
                    </tr>
